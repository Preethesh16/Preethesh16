...
<div align="center">
  <sub>LANGUAGES</sub>
  <br />
  <img src="https://skillicons.dev/icons?i=ts,python,java,js,kotlin,dart,cpp,c,bash" alt="Languages" />
  <br /><br />
  <sub>FRONTEND · BACKEND · AI</sub>
  <br />
  <img src="https://skillicons.dev/icons?i=react,nextjs,tailwind,nodejs,express,fastapi,pytorch,opencv" alt="Frontend, backend, and AI stack" />
  <br /><br />
  <sub>DATA · CLOUD · MOBILE · EMBEDDED</sub>
  <br />
  <img src="https://skillicons.dev/icons?i=postgres,mongodb,redis,supabase,firebase,docker,vercel,flutter,arduino,linux,git,github" alt="Data, cloud, mobile, and embedded stack" />
</div>
...
<div align="center">
  <p><i>Find me online · let’s build something meaningful</i></p>
</div>
